    ...
    <section class="platforms-section section-content">
        <div class="container">
            ...
            <div class="sitetitle sitetitle-xl sitetitle-dark sitetitle-center sitetitle-width900">
                <h2 data-aos="fade-up" data-aos-duration="1000" data-aos-delay="0"><span class="sitecolorgreen">ABOUT</span> METATRADER <span class="sitecolororange">4</span> MOBILE</h2>
            ...
            <div class="platforms-area">
                <div class="platforms-area-box" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500">
                    <div class="row">
                        ...
                        <div class="sitecontent-desc col">
                            <h3>METATRADER <span class="sitecolororange">4</span> FOR ANDROID</h3>
                            <p>Download MT4 on the popular Android operating system to enjoy unlimited market access wherever you are and whatever you’re doing. Available on both mobile and tablet, MT4 for Android makes it more convenient than ever to trade.</p>
                        ...
                        <div class="col-auto" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="750">
                            <img src="assets/img/section/platforms_detail_mt_cont_img_android.jpg" alt="MT4 ANDROID" width="600" height="500" />
                        </div>
                        <!-- Image -->
                ...
                <div class="platforms-area-box" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500">
                    <div class="row">
                        ...
                        <!-- Desc -->
                        <div class="sitecontent-desc col">
                            <h3>METATRADER <span class="sitecolororange">4</span> FOR IOS</h3>
                            <p>Prefer to trade from your iPhone or iPad? Download MT4 for iOS straight from the Apple App Store and let your market journey begin! Access the financial markets at a time and place to suit you and manage your trading activity with complete ease.</p>
                            <p>MT4’s features include:</p>
                            <ul class="ullist ullist-dotted">
